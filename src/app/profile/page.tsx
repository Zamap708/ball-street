...
export const metadata: Metadata = {
  title: "Next.js Profile | Ball Street - Next.js Dashboard Template",
  description:
    "This is Next.js Profile page for Ball Street - Next.js Tailwind CSS Admin Dashboard Template",
};
