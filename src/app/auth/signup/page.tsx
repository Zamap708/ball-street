...
export const metadata: Metadata = {
  title: "Next.js SignUp Page | Ball Street - Next.js Dashboard Template",
  description: "This is Next.js SignUp Page Ball Street Dashboard Template",
  // other metadata
};
